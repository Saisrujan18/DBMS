				...
				<div className="flex flex-col">
					<div className="self-end">
						<div className="dropdown">
							<p tabindex="0" className="text-medium m-1 btn clickables">Filter</p>
							<ul tabindex="0" className="p-2 shadow menu dropdown-content bg-white text-black rounded-box w-52 text-sm">
